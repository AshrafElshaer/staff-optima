...
function Calendar({
	...
	// Calculate year range for dropdown (10 years past to 10 years future)
		...
		<DayPicker
			...
			formatters={{
				...
				formatYearDropdown: (date) => {
					...
					// Show years from 10 years ago to 10 years in the future
